...
danger = (2-coeff)*fire_norm_2d + (coeff)*animal_norm_2d   # [0, 2], NaN outside park
...
drone_df = pd.read_csv("drone_paths_filtered_0.5.csv")
human_df = pd.read_csv("human_paths_filtered_0.5.csv")
...
pd.DataFrame(rows_out).to_csv("etosha_path_results_0.5change.csv", index=False)
print("Cell-level results   -> etosha_path_results_0.5change.csv")
